...
class MockCellCollector {
  ...
  async *collect() {
    yield {
      ...mockCell,
      data: '0xa150f10500000000000000000000000001000000f000000000000000000000000003000000000000000000',
    }
    yield {
      ...mockCell,
      data: '0x',
    ...
    yield {
      ...mockCell,
      data: '0xa150f10500000000000000000000000001000000f000000000000000000000000004000000000000000000',
    }
    return
  }
}
