...
class MockCellCollector {
  ...
  async *collect() {
    yield {
      ...mockCell,
      data: '0xa150f10500000000000000000000000001000000f000000000000000000000000000000000000000030000',
    }
    yield {
      ...mockCell,
      data: '0x',
    ...
    yield {
      ...mockCell,
      data: '0xa150f10500000000000000000000000001000000f000000000000000000000000000000000000000040000',
    }
    return
  }
}
