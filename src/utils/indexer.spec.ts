...
class MockCellCollector {
  ...
  async *collect() {
    yield {
      ...mockCell,
      data: '0xa150f105000000000000000000000000000000f000000000000000000000000000003029881a5643100000000000000000',
    }
    yield {
      ...mockCell,
      data: '0x',
    ...
    yield {
      ...mockCell,
      data: '0xa150f105000000000000000000000000000000f000000000000000000000000000003029881a7a319386bc270000000001',
    }
    return
  }
}
